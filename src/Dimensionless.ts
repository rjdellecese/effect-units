...
// fraction, so `one` is 100%, 500 basis points, and 50,000 ppm alike.
//
...
// and `Quantity.timesUnitless`/`overUnitless` apply one without leaving the
// units they scale.
...
/** A factor of one: the identity for `Quantity.timesUnitless`, and 100%. */
