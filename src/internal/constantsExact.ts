 ...
 * test/ConstantsExact.test.ts asserts bit-identity between the two
 * families.
 *
 * @module
 */
...
export const metersPerInch = Rational.makeUnsafe(127n, 5000n);

/** Meters per international foot (12 inches). */
export const metersPerFoot = Rational.makeUnsafe(381n, 1250n);

/** Meters per international yard (3 feet). */
export const metersPerYard = Rational.makeUnsafe(1143n, 1250n);

/** Meters per international mile (1760 yards). */
export const metersPerMile = Rational.makeUnsafe(201168n, 125n);

/** Kilograms per avoirdupois pound. */
export const kilogramsPerPound = Rational.makeUnsafe(45359237n, 100000000n);

/** Standard gravity, in meters per second squared. */
export const gee = Rational.makeUnsafe(196133n, 20000n);
...
export const secondsPerMinute = Rational.makeUnsafe(60n);

export const secondsPerHour = Rational.makeUnsafe(3600n);
